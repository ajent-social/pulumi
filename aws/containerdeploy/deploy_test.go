...
func TestValidateArgsRejectsRegionMismatch(t *testing.T) {
	err := containerdeploy.ValidateArgs(containerdeploy.Args{
		Name: "app", ClusterARN: "arn:aws:ecs:us-west-2:123456789012:cluster/c",
		Image: "123456789012.dkr.ecr.us-east-1.amazonaws.com/app@sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
		CPU: "256", Memory: "512", ContainerPort: 8080, Region: "us-west-2",
		SubnetIDs: []string{"subnet-abc"}, SecurityGroupIDs: []string{"sg-1"},
		ExecutionRoleARN: "arn:aws:iam::123456789012:role/exec",
		TaskRoleARN:      "arn:aws:iam::123456789012:role/task",
	})
	if err == nil {
		t.Fatal("expected reject ECR/Region mismatch")
	}
}

func TestValidateArgsTargetGroupARN(t *testing.T) {
	base := containerdeploy.Args{
		Name: "app", ClusterARN: "arn:aws:ecs:us-east-1:123456789012:cluster/c",
		Image: "123456789012.dkr.ecr.us-east-1.amazonaws.com/app@sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
		CPU: "256", Memory: "512", ContainerPort: 8080, Region: "us-east-1",
		SubnetIDs: []string{"subnet-abc"}, SecurityGroupIDs: []string{"sg-1"},
		ExecutionRoleARN: "arn:aws:iam::123456789012:role/exec",
		TaskRoleARN:      "arn:aws:iam::123456789012:role/task",
		TargetGroupARN:   "arn:aws:elasticloadbalancing:us-east-1:123456789012:targetgroup/app/abc",
	}
	if err := containerdeploy.ValidateArgs(base); err != nil {
		t.Fatal(err)
	}
	base.TargetGroupARN = "not-an-arn"
	if err := containerdeploy.ValidateArgs(base); err == nil {
		t.Fatal("expected reject bad target group ARN")
	}
}
